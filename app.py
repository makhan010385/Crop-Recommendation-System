...
with st.sidebar:
    ...
    st.markdown(f"""<h4 style='text-align: center; color: black;'>
     ...
     href = "https://github.com/makhan010385/Crop-Recommendation-System">GitHub</a> <a style='text-align: center; color: black;' 
     type="button" class="btn btn-warning btn-lg" 
     href = "https://www.linkedin.com/in/makhan-kumbhkar-44b5361a/">Linkedin</a></h4>""", unsafe_allow_html=True)
...
with coly:
    st.markdown("""
      ...
      <h6 style='text-align: center;'>
        ...
        href="https://github.com/makhan010385/Crop-Recommendation-System/blob/main/Crop_recommendation.csv">Dataset</a>.
...
with coly:
    ...
    fig.update_traces(marker_color="#1AB43C")
